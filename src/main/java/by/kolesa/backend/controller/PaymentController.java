...
public class PaymentController {
  ...
  public String payWithPaypal(
      @ModelAttribute("payment") PaymentDto paymentDto, HttpServletResponse resp) {
    Payment payment =
        paymentsService.createPaypalPayment(
            paymentDto.getAmount(), paypalFailureUrl, paypalSuccessUrl);
  ...
  @ResponseBody
  public ResponseEntity<String> paySuccess(
      @RequestParam String paymentId, @RequestParam("PayerID") String payerId) {
